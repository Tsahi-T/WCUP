...
export const SEED_MATCHES: SeedMatch[] = [
  ...
  // ===== שלב 32 (28 יוני – 4 יולי) =====
  // שמות הקבוצות יתמלאו על ידי המנהל לאחר שלב הבתים
  // "?" = טרם נקבע · המנהל יעדכן דרך לשונית ניהול
  { id: "r1",  teamA: "?", teamB: "?", date: "2026-06-28T19:00:00Z", stage: "שלב 32" },  // שניית A vs שניית B
  { id: "r2",  teamA: "?", teamB: "?", date: "2026-06-29T17:00:00Z", stage: "שלב 32" },  // מנצחת C vs שניית F
  { id: "r3",  teamA: "?", teamB: "?", date: "2026-06-29T20:30:00Z", stage: "שלב 32" },  // מנצחת E vs שלישית
  { id: "r4",  teamA: "?", teamB: "?", date: "2026-06-30T01:00:00Z", stage: "שלב 32" },  // מנצחת F vs שניית C
  { id: "r5",  teamA: "?", teamB: "?", date: "2026-06-30T17:00:00Z", stage: "שלב 32" },  // שניית E vs שניית I
  { id: "r6",  teamA: "?", teamB: "?", date: "2026-06-30T21:00:00Z", stage: "שלב 32" },  // מנצחת I vs שלישית
  { id: "r7",  teamA: "?", teamB: "?", date: "2026-07-01T01:00:00Z", stage: "שלב 32" },  // מנצחת A vs שלישית
  { id: "r8",  teamA: "?", teamB: "?", date: "2026-07-01T16:00:00Z", stage: "שלב 32" },  // מנצחת L vs שלישית
  { id: "r9",  teamA: "?", teamB: "?", date: "2026-07-01T20:00:00Z", stage: "שלב 32" },  // מנצחת G vs שלישית
  { id: "r10", teamA: "?", teamB: "?", date: "2026-07-02T00:00:00Z", stage: "שלב 32" },  // מנצחת D vs שלישית
  { id: "r11", teamA: "?", teamB: "?", date: "2026-07-02T19:00:00Z", stage: "שלב 32" },  // מנצחת H vs שניית J
  { id: "r12", teamA: "?", teamB: "?", date: "2026-07-02T23:00:00Z", stage: "שלב 32" },  // שניית K vs שניית L
  { id: "r13", teamA: "?", teamB: "?", date: "2026-07-03T03:00:00Z", stage: "שלב 32" },  // מנצחת B vs שלישית
  { id: "r14", teamA: "?", teamB: "?", date: "2026-07-03T18:00:00Z", stage: "שלב 32" },  // שניית D vs שניית G
  { id: "r15", teamA: "?", teamB: "?", date: "2026-07-03T22:00:00Z", stage: "שלב 32" },  // מנצחת J vs שניית H
  { id: "r16", teamA: "?", teamB: "?", date: "2026-07-04T01:30:00Z", stage: "שלב 32" },  // מנצחת K vs שלישית

  // ===== שמינית גמר (4–7 יולי) =====
  { id: "r17", teamA: "?", teamB: "?", date: "2026-07-04T17:00:00Z", stage: "שמינית גמר" },
  { id: "r18", teamA: "?", teamB: "?", date: "2026-07-04T21:00:00Z", stage: "שמינית גמר" },
  { id: "r19", teamA: "?", teamB: "?", date: "2026-07-05T20:00:00Z", stage: "שמינית גמר" },
  { id: "r20", teamA: "?", teamB: "?", date: "2026-07-06T00:00:00Z", stage: "שמינית גמר" },
  { id: "r21", teamA: "?", teamB: "?", date: "2026-07-06T19:00:00Z", stage: "שמינית גמר" },
  { id: "r22", teamA: "?", teamB: "?", date: "2026-07-07T00:00:00Z", stage: "שמינית גמר" },
  { id: "r23", teamA: "?", teamB: "?", date: "2026-07-07T16:00:00Z", stage: "שמינית גמר" },
  { id: "r24", teamA: "?", teamB: "?", date: "2026-07-07T20:00:00Z", stage: "שמינית גמר" },

  // ===== רבע גמר (9–12 יולי) =====
  { id: "r25", teamA: "?", teamB: "?", date: "2026-07-09T20:00:00Z", stage: "רבע גמר" },
  { id: "r26", teamA: "?", teamB: "?", date: "2026-07-10T19:00:00Z", stage: "רבע גמר" },
  { id: "r27", teamA: "?", teamB: "?", date: "2026-07-11T21:00:00Z", stage: "רבע גמר" },
  { id: "r28", teamA: "?", teamB: "?", date: "2026-07-12T01:00:00Z", stage: "רבע גמר" },

  // ===== חצי גמר (14–15 יולי) =====
  { id: "r29", teamA: "?", teamB: "?", date: "2026-07-14T19:00:00Z", stage: "חצי גמר" },
  { id: "r30", teamA: "?", teamB: "?", date: "2026-07-15T19:00:00Z", stage: "חצי גמר" },

  // ===== גמר 3/4 ו-גמר (18–19 יולי) =====
  { id: "r31", teamA: "?", teamB: "?", date: "2026-07-18T21:00:00Z", stage: "מקום 3" },
  { id: "r32", teamA: "?", teamB: "?", date: "2026-07-19T19:00:00Z", stage: "🏆 גמר" },
];
